...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference("Style.count") do
      post styles_url, params: { style: { beer_id: @style.beer_id, description: @style.description, name: @style.name } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { beer_id: @style.beer_id, description: @style.description, name: @style.name } }
